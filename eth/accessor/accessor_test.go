...
//
//	blockMark:
//		var blockWithTxHash myethTypes.BlockWithTxHash
...
//		}
//
//		blockWithTxAndReceipt := &myethTypes.BlockWithTxAndReceipt{}
//		blockWithTxAndReceipt.Block = blockWithTxHash.Block
//		blockWithTxAndReceipt.Transactions = []myethTypes.Transaction{}
//		blockWithTxAndReceipt.Receipts = []myethTypes.TransactionReceipt{}
//
...
//				rc    myethTypes.TransactionReceipt
//				rcerr error
//			)
//
//			rcreq.TxHash = txstr
...
//	var tx myethTypes.TransactionReceipt
...
//		t.Fatalf(err.Error())
//	}
//	block := ret.(*myethTypes.BlockWithTxAndReceipt)
...
func TestEthNodeAccessor_Call(t *testing.T) {
	...
	accessor.Initialize(accessor.AccessorOptions{RawUrls: []string{"http://ec2-13-115-183-194.ap-northeast-1.compute.amazonaws.com:8545"}})
